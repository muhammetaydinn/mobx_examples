...
mixin _$DiceCounter on _DiceCounterBase, Store {
  ...
  late final _$leftAtom = Atom(name: '_DiceCounterBase.left', context: context);
  ...
  late final _$rightAtom =
      Atom(name: '_DiceCounterBase.right', context: context);
  ...
  late final _$_DiceCounterBaseActionController =
      ActionController(name: '_DiceCounterBase', context: context);
